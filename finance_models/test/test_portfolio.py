...
class TestVAR(unittest.TestCase):
    ...
    def test_calc_retorno_func(self):
        ...
        ret = portfolio.VaR().calcula_retorno(precos = precos, holding_period = 1)
    ...
    def test_calc_logretorno_func(self):
        ...
        ret = portfolio.VaR().calcula_log_retorno(precos = precos, holding_period = 1)
    ...
    def test_calc_var_func(self):
        ...
        var_final = tools.Money(portfolio.VaR().calcula_var(
            retornos = ret.iloc[:-1],
            alpha = alpha,
    ...
    def test_calc_es_func(self):
        ...
        es_final = tools.Money(portfolio.VaR().calcula_es(
            retornos = ret.iloc[:-1],
            alpha = alpha,
            vlr_carteira_atual = vlr_carteira
        ))
